...
@php
    $heads = [['label' => 'No', 'width' => 2], 'Nama', 'Role', 'Verifikasi', 'Tanggal Daftar', ['label' => 'Actions', 'width' => 5]];
    $config = [
        'serverSide' => true,
        'processing' => true,
        'ajax' => ['url' => route('users.index')],
        'order' => [[0, 'asc']],
        'columns' => [['data' => 'DT_RowIndex'], ['data' => 'name'], ['data' => 'role'], ['data' => 'email_verified_at'], ['data' => 'created_at'], ['data' => 'actions']],
    ];
@endphp
@section('content')
    <div class="card">
    ...
    <form id="addUser">
        <x-adminlte-modal id="addUserModal" title="Add User">
            ...
            <x-adminlte-input name="username" label="Username" placeholder="Masukkan username" disable-feedback />
    ...
    <form id="editUser">
        <x-adminlte-modal id="editUserModal" title="Edit User">
            ...
            <x-adminlte-input id="editUsername" name="username" label="Username" placeholder="Masukkan username" disable-feedback />
